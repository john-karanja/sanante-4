...
if ( ! function_exists( 'pharmacare_core_add_simple_line_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'PharmaCareCore_Simple_Line_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'pharmacare_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PharmaCareCore_Simple_Line_Icons_Pack extends QodeFrameworkIconPack {
