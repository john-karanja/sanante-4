...
if ( ! function_exists( 'pharmacare_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'PharmaCareCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'pharmacare_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PharmaCareCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return PHARMACARE_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( PHARMACARE_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( PHARMACARE_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
