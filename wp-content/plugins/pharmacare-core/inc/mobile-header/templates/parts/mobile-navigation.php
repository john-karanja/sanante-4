<?php if ( has_nav_menu( 'mobile-navigation' ) || has_nav_menu( 'main-navigation' ) ) { ?>
	<nav class="qodef-mobile-header-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Mobile Menu', 'pharmacare-core' ); ?>">
		<?php
		...
		wp_nav_menu(
			array(
				...
				'link_after'     => '</span>',
				'walker'         => new PharmaCareCoreRootMainMenuWalker(),
			)
		);
		?>
	</nav>
