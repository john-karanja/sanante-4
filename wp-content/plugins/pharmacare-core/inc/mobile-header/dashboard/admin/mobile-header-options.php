...
if ( ! function_exists( 'pharmacare_core_add_mobile_header_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function pharmacare_core_add_mobile_header_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'mobile-header',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Mobile Header', 'pharmacare-core' ),
				'description' => esc_html__( 'Global Mobile Header Options', 'pharmacare-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$general_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Sticky Mobile Header', 'pharmacare-core' ),
					'description'   => esc_html__( 'Set mobile header to be sticky', 'pharmacare-core' ),
				)
			);
			...
			$general_tab->add_field_element(
				array(
					...
					'default_value' => apply_filters( 'pharmacare_core_filter_mobile_header_layout_default_option', '' ),
					'options'       => apply_filters( 'pharmacare_core_filter_mobile_header_layout_option', array() ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Open Icon SVG Path', 'pharmacare-core' ),
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Close Icon SVG Path', 'pharmacare-core' ),
			...
			do_action( 'pharmacare_core_action_after_mobile_header_options_map', $page, $general_tab );
		}
	}

	add_action( 'pharmacare_core_action_default_options_init', 'pharmacare_core_add_mobile_header_options', pharmacare_core_get_admin_options_map_position( 'mobile-header' ) );
}
