...
if ( ! class_exists( 'PharmaCareCore_Shortcodes' ) ) {
	class PharmaCareCore_Shortcodes {
		...
		/**
		 * @return PharmaCareCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once PHARMACARE_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once PHARMACARE_CORE_SHORTCODES_PATH . '/class-pharmacarecore-shortcode.php';
			include_once PHARMACARE_CORE_SHORTCODES_PATH . '/class-pharmacarecore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'pharmacare_core_filter_register_shortcodes', $shortcodes = array() );
	...
	PharmaCareCore_Shortcodes::get_instance();
}
