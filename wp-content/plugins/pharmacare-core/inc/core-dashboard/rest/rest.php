...
if ( ! class_exists( 'PharmaCareCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class PharmaCareCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'pharmacare_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return PharmaCareCoreDashboardRestAPI
		 */
	...
	PharmaCareCoreDashboardRestAPI::get_instance();
}
