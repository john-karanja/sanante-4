...
class PharmaCareCore_Standard_Header extends PharmaCareCore_Header {
	...
	/**
	 * @return PharmaCareCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return pharmacare_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
