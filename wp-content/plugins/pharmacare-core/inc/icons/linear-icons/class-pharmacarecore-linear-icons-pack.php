...
if ( ! function_exists( 'pharmacare_core_add_linear_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'PharmaCareCore_Linear_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'pharmacare_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PharmaCareCore_Linear_Icons_Pack extends QodeFrameworkIconPack {
