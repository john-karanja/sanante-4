...
if ( ! function_exists( 'pharmacare_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'PharmaCareCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'pharmacare_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PharmaCareCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
