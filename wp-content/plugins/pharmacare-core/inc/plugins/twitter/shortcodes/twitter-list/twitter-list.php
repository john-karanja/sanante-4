...
if ( ! function_exists( 'pharmacare_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'PharmaCareCore_Twitter_List_Shortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'pharmacare_core_filter_register_shortcodes', 'pharmacare_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'PharmaCareCore_List_Shortcode' ) ) {
	class PharmaCareCore_Twitter_List_Shortcode extends PharmaCareCore_List_Shortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( PHARMACARE_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'pharmacare_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'pharmacare-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'pharmacare-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'pharmacare-core' ),
				'group'      => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'pharmacare-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'pharmacare-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'pharmacare-core' ),
				'options'       => pharmacare_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'pharmacare-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return pharmacare_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
