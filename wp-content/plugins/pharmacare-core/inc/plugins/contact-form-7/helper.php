...
if ( ! function_exists( 'pharmacare_core_get_contact_form_7_forms' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_get_contact_form_7_forms() {
		$options       = array();
		...
		if ( ! empty( $contact_forms ) ) {
			...
			$options[0] = esc_html__( 'No contact forms found', 'pharmacare-core' );
		}
