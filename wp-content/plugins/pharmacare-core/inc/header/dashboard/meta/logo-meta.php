...
if ( ! function_exists( 'pharmacare_core_add_page_logo_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function pharmacare_core_add_page_logo_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$logo_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-logo',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Logo Settings', 'pharmacare-core' ),
					'description' => esc_html__( 'Logo settings', 'pharmacare-core' ),
				)
			);
			...
			do_action( 'pharmacare_core_action_after_page_logo_meta_map', $logo_tab, $header_logo_section );
		}
	}

	add_action( 'pharmacare_core_action_after_general_meta_box_map', 'pharmacare_core_add_page_logo_meta_box' );
}

if ( ! function_exists( 'pharmacare_core_add_general_logo_meta_box_callback' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_general_logo_meta_box_callback( $callbacks ) {
		$callbacks['logo'] = 'pharmacare_core_add_page_logo_meta_box';

		return $callbacks;
	}

	add_filter( 'pharmacare_core_filter_general_meta_box_callbacks', 'pharmacare_core_add_general_logo_meta_box_callback' );
}
