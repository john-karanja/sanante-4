...
if ( ! function_exists( 'pharmacare_core_dropdown_item_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_dropdown_item_classes( $classes, $item, $args, $depth ) {

		if ( 0 === $depth && in_array( 'menu-item-has-children', $item->classes, true ) ) {
			$mega_menu   = pharmacare_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu', '', $item->ID );
			$mega_menu_e = is_array( $mega_menu ) && in_array( 'enable', $mega_menu, true );
			$mega_menu_5_col   = pharmacare_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-5-col', '', $item->ID );
			$mega_menu_5_col_e = is_array( $mega_menu_5_col ) && in_array( 'enable', $mega_menu_5_col, true );
			$mega_menu_6_col   = pharmacare_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-6-col', '', $item->ID );
			$mega_menu_6_col_e = is_array( $mega_menu_6_col ) && in_array( 'enable', $mega_menu_6_col, true );
			$mega_menu_wide_col   = pharmacare_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-wide-last-column', '', $item->ID );
			$mega_menu_wide_col_e = is_array( $mega_menu_wide_col ) && in_array( 'enable', $mega_menu_wide_col, true );
			$custom_menu_class   = pharmacare_core_get_option_value( 'nav-menu', 'qodef-wide-custom-class', '', $item->ID );

			if ( $mega_menu_e ) {
				$classes   = array_diff( $classes, array( 'qodef-menu-item--narrow' ) );

				if ( !empty($custom_menu_class) ) {
					$classes[] = $custom_menu_class;
				}

				if ( $mega_menu_wide_col_e ) {
					$classes[] = 'qodef-wide-last-col';
				}

				if ( $mega_menu_5_col_e ) {
					$classes[] = 'qodef-menu-item--wide qodef-wide-5-col';
				}

				else if ( $mega_menu_6_col_e ) {
					$classes[] = 'qodef-menu-item--wide qodef-wide-6-col';
				}
				else	$classes[] = 'qodef-menu-item--wide';

				add_filter(
					'pharmacare_core_filter_drop_down_second_inner_classes',
					function ( $inner_classes ) {
						$grid_class = false;
						$full_width = pharmacare_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
						$grid       = pharmacare_core_get_post_value_through_levels( 'qodef_wide_dropdown_content_grid' );

						if ( 'yes' === $grid || 'no' === $full_width ) {
							$grid_class = true;
						}

						$grid_class = apply_filters( 'pharmacare_core_filter_drop_down_grid', $grid_class );
	...
	add_filter( 'nav_menu_css_class', 'pharmacare_core_dropdown_item_classes', 11, 4 );
}

if ( ! function_exists( 'pharmacare_core_add_nav_menu_body_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_nav_menu_body_classes( $classes ) {
		$full_width = pharmacare_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
		$appearance = pharmacare_core_get_post_value_through_levels( 'qodef_dropdown_appearance' );
	...
	add_filter( 'body_class', 'pharmacare_core_add_nav_menu_body_classes' );
}

if ( ! function_exists( 'pharmacare_core_set_nav_menu_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function pharmacare_core_set_nav_menu_styles( $style ) {
		$styles = array();

		$dropdown_top_position = pharmacare_core_get_post_value_through_levels( 'qodef_dropdown_top_position' );
	...
	add_filter( 'pharmacare_filter_add_inline_style', 'pharmacare_core_set_nav_menu_styles' );
}

if ( ! function_exists( 'pharmacare_core_set_nav_menu_typography_styles' ) ) {
	/**
	 * Function that generates module inline styles
	 *
	 * @param string $style
	 ...
	 * @return string
	 */
	function pharmacare_core_set_nav_menu_typography_styles( $style ) {
		$scope = PHARMACARE_CORE_OPTIONS_NAME;

		$first_lvl_styles             = pharmacare_core_get_typography_styles( $scope, 'qodef_nav_1st_lvl' );
		$first_lvl_hover_styles       = pharmacare_core_get_typography_hover_styles( $scope, 'qodef_nav_1st_lvl' );
		$second_lvl_styles            = pharmacare_core_get_typography_styles( $scope, 'qodef_nav_2nd_lvl' );
		$second_lvl_hover_styles      = pharmacare_core_get_typography_hover_styles( $scope, 'qodef_nav_2nd_lvl' );
		$second_lvl_wide_styles       = pharmacare_core_get_typography_styles( $scope, 'qodef_nav_2nd_lvl_wide' );
		$second_lvl_wide_hover_styles = pharmacare_core_get_typography_hover_styles( $scope, 'qodef_nav_2nd_lvl_wide' );
		$third_lvl_wide_styles        = pharmacare_core_get_typography_styles( $scope, 'qodef_nav_3rd_lvl_wide' );
		$third_lvl_wide_hover_styles  = pharmacare_core_get_typography_hover_styles( $scope, 'qodef_nav_3rd_lvl_wide' );

		$header_selector      = apply_filters( 'pharmacare_core_filter_nav_menu_header_selector', '.qodef-header-navigation' );
		$narrow_menu_selector = apply_filters( 'pharmacare_core_filter_nav_menu_narrow_header_selector', '.qodef-menu-item--narrow' );
		$wide_menu_selector   = '.qodef-menu-item--wide';

		$first_lvl_side_padding = pharmacare_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_padding' );
		...
		$first_lvl_active_color = pharmacare_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_active_color' );
		...
		$first_lvl_side_margin = pharmacare_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_margin' );
		...
		$second_lvl_active_color = pharmacare_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_active_color' );
		...
		$second_lvl_wide_active_color = pharmacare_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_wide_active_color' );
		...
		$third_lvl_wide_active_color = pharmacare_core_get_option_value( 'admin', 'qodef_nav_3rd_lvl_wide_active_color' );
	...
	add_filter( 'pharmacare_filter_add_inline_style', 'pharmacare_core_set_nav_menu_typography_styles' );
}
