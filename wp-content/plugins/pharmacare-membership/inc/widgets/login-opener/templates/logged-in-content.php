...
<div class="qodef-logged-in-user qodef-m">
	<div class="qodef-m-user">
		...
		$user_image      = get_avatar( $current_user_id, 38 );
		
		if ( ! empty( $user_image ) ) { ?>
			<span class="qodef-m-user-image"><?php echo get_avatar( $current_user_id, 38 ); ?></span>
		<?php } ?>
		<div class="qodef-m-user-holder">
			<span class="qodef-m-user-label"><?php echo esc_html__( 'Account', 'pharmacare-membership' ); ?></span>
	...
	<ul class="qodef-m-navigation-items">
		...
		$nav_items     = pharmacare_membership_get_dashboard_navigation_pages();
