...
if ( ! function_exists( 'pharmacare_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_get_filter_items( $params ) {
		...
		return apply_filters( 'pharmacare_filter_get_filter_items', $items, $params );
	}
}
