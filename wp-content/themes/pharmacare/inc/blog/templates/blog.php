<div class="qodef-grid-item <?php echo esc_attr( pharmacare_get_page_content_sidebar_classes() ); ?>">
	...
	do_action( 'pharmacare_action_before_blog_loop' );
	?>
	<div class="qodef-blog flex-container qodef-m <?php echo esc_attr( pharmacare_get_blog_holder_classes() ); ?>">
		<?php
		// Include posts loop
		pharmacare_template_part( 'blog', 'templates/parts/loop' );
