...
if ( ! function_exists( 'pharmacare_core_add_product_list_variation_info_right' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pharmacare_core_add_product_list_variation_info_right( $variations ) {
		$variations['info-right'] = esc_html__( 'Info Right', 'pharmacare-core' );
		
		return $variations;
	}
	
	add_filter( 'pharmacare_core_filter_product_list_layouts', 'pharmacare_core_add_product_list_variation_info_right' );
}

if ( ! function_exists( 'pharmacare_core_register_shop_list_info_right_actions' ) ) {
    /**
     * Function that override product item layout for current variation type
     */
    function pharmacare_core_register_shop_list_info_right_actions() {
    ...
    add_action( 'pharmacare_core_action_shop_list_item_layout_info-right', 'pharmacare_core_register_shop_list_info_right_actions' );
}